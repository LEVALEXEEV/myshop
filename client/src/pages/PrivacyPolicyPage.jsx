  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col">
      ...
      >
        ...
        <div className="w-full box-border px-[3vw] pt-[60px] pb-[40px]">
          <div className="flex flex-col gap-8 md:gap-4 mb-4 md:mb-8">
            <div className="text-xs text-[#545454] uppercase">
              <span className="text-[#c0c0c0]">Главная /</span> ПОЛИТИКА
              КОНФИДЕНЦИАЛЬНОСТИ
            </div>

            <div className="flex flex-col-reverse xl:flex-row justify-between items-start xl:items-center gap-4 md:gap-3">
              <div className="text-base md:text-xl xl:text-2xl font-bold uppercase leading-[18px] md:leading-tight">
                Политика в отношении обработки персональных данных
              </div>
              <div className="text-xs md:text-sm xl:text-base uppercase text-[#8c8c8c]">
                Последнее обновление 16.11.2024
              </div>
            </div>
          </div>

          <div className="text-[15px] md:text-[17px] leading-[20px] md:leading-[24px] font-arial">
            <div>
              1. Общие положения
              <br />
              ...
              предпринимаемые https://resego.su (далее – Оператор).
              <br />
              ...
              <br />
              2.10. Пользователь – любой посетитель веб-сайта https://resego.su.
              <br />
              2.11. Предоставление персональных данных – действия, направленные
              на раскрытие персональных данных определенному лицу
              <br />
              ...
              либо сведения о другом субъекте персональных данных
              <br />
              ...
              материалам, содержащимся на веб-сайте https://resego.su.
              <br />
              ...
              адрес электронной почты resego-support@mail.ru с пометкой «Отказ
              ...
              <br />
              о действиях Пользователей на сайте, улучшения качества сайта и его
              содержания.
              <br />
              ...
              через специальные формы, расположенные на сайте https://resego.su
              ...
              полном объеме требований действующего законодательства
              <br />
              в области защиты персональных данных.
              <br />
              10.1. Оператор обеспечивает сохранность персональных данных и
              принимает все возможные меры, исключающие доступ
              <br />
              ...
              Оператора resego-support@mail.ru с пометкой «Актуализация
              персональных данных».
              <br />
              ...
              resego-support@mail.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
              <br />
              ...
              сети Интернет по адресу https://resego.su/privacy-policy/.
            </div>
          </div>
        </div>
